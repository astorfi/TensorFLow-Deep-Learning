...
A deep learning is of great interest these days, the crucial necessity for rapid and optimised implementation of the algorithms
...
TensorFlow is it flexibility is designing highly modular model which also can be a disadvantage too for a beginner since lots of
...
be overcome easily since they might be the issues of lots of other people considering a large number of people involved in TensorFlow community.

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
What's the point of this repository?
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

**Developing open source project for the sake of just developing something is not the behind the reason for this effort**.
...
and simple and optimised code implementation to provide better insight about how to use TensorFlow *fast and efficient*. It is worth
...
The virtual environment installation is recommended in order to prevent package conflict and having the capacity to customise the working environment. The TensorFlow version employed for these tutorials is `1.1`. However, the files from previous versions can be transformed to newer versions (ex: version `1.1`) using the instructions available in the following link:
...
email, or any other method with the owners of this repository before making a change. *For typos, please do not create a pull request. Instead, declare them in issues or email the repository owner*.
